...
/**
 * Program for Ability to save the Total Wage for Each Company-UC9
 * 
 * @author S A H A R A
 *
 */
public class EmpSaveTotalWage {
	// Declared Constant
	...
	public EmpSaveTotalWage(String company, int emp_Wage_Per_Hr, int max_Working_Days, int maxHr_In_Month) {
	...
	public static void main(String[] args) {
		...
		EmpSaveTotalWage nike = new EmpSaveTotalWage("Nike", 50, 25, 150);
		EmpSaveTotalWage tcs = new EmpSaveTotalWage("TCS", 60, 26, 120);
